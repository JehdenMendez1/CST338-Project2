...
public class CardDesign extends VBox {
    ...
    public CardDesign() {
        ...
        abilityLabel.setStyle("-fx-text-fill: lightgray; -fx-font-size: 10;");

        getChildren().addAll(nameLabel, imageView, healthBar, abilityLabel);
    }
    ...
    public void setCardData(Card card) {
        ...
        try {
            imageView.setImage(new Image(getClass().getResourceAsStream(card.getImageAsset())));
        } catch (Exception e) {
